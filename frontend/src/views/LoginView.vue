...
<template>
  <main class="max-w-md mx-auto mt-16">
    ...
    <div class="mt-8 flex justify-center">
      <RouterLink 
        to="/resultados" 
        class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-cyan-800 bg-cyan-50 border border-cyan-200 rounded-xl hover:bg-cyan-100 hover:text-cyan-900 transition-all duration-200 shadow-sm"
      >
